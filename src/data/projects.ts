export const projects = [
  {
    ...
    imageUrl: 'https://placehold.co/800x600/f0f0f0/333?text=VMC+Project',
    detail: {
      experience: "VMC had a tight deadline to get their new site live in just 7 short weeks, and we were excited to rise to the challenge! We loved applying VMC's new galactic-inspired brand to custom elements throughout the site, including layered identity elements, on scroll animation and more.",
      ...
      images: [
        'https://placehold.co/1200x800/e0e0e0/333?text=Stone+Art+1',
        'https://placehold.co/600x800/d0d0d0/333?text=Stone+Art+2',
        'https://placehold.co/600x800/c0c0c0/333?text=Stone+Art+3',
      ]
    }
  },
  {
    ...
    imageUrl: 'https://placehold.co/800x600/f0f0f0/333?text=Aurora+Project',
    detail: { // Using VMC detail as a template
      experience: "Aurora had a tight deadline to get their new site live in just 8 short weeks, and we were excited to rise to the challenge!",
      challenge: "The primary challenge in this project was to visualize complex energy data in an intuitive and beautiful way.",
      results: "The finished website provided a powerful tool for stakeholders, highlighting the unique value proposition of Aurora's technology.",
      testimonial: {
